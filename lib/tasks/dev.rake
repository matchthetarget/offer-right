namespace :dev do
  ...
  task prime: :environment do
    ...
    items = [
      ...
      { id: 3, category_id: 2, title: "Heavy Iron & Glass Round Table", price: 129, location: "THE MCMANUS CENTER ", seller_id: 83, buyer_id: nil, image: "https://res-1.cloudinary.com/initialversion/image/upload/v1637079178/tikxe2wqhdtcubvkh8uv.jpg", description: "30\" diameter x 16\"h", created_at: "2018-03-05 07:37:08", updated_at: "2019-10-08 10:25:00" },
      ...
      { id: 10, category_id: 1, title: "5-foot kitchen oval table", price: 100, location: "THE MCMANUS CENTER ", seller_id: 84, buyer_id: 85, image: "https://res.cloudinary.com/dt1gn6erd/image/upload/v1645043609/aa5c9a57c09b7dc227bdf9839254b948.jpg", description: "5-foot kitchen oval table with a 2-foot leaf and 6-chairs let me know asap ", created_at: "2018-03-05 07:37:08", updated_at: "2019-10-08 10:25:00" },
      { id: 11, category_id: 3, title: "11 Inch Queen Size Gel Memory Foam Mattress With Zipper ", price: 178, location: "THE MCMANUS CENTER ", seller_id: 85, buyer_id: nil, image: "http://res-4.cloudinary.com/initialversion/image/upload/v1637079184/rfgqc3efouajdcl3oule.jpg", description: "Size: Queen Thickness: 11 in Length: 76 in Width: 66 in Color: White Features: Adjustable, Memory Foam Layer, Pressure Release, Washable, With Zipper", created_at: "2018-03-05 07:37:08", updated_at: "2019-10-08 10:25:00" },
